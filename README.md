# <center> DataTalks Club: Data Engineering Zoomcamp 2024 </center>
---
Table of Contents
- [Module 1: ...](#module-1-)
...
/**
  ...
  query will always order the results by `pu_location_id` and filter based on
  `pickup_datetime`? (Create a new table with this strategy)
**/
